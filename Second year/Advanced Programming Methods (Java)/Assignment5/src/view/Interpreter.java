...
public class Interpreter {
    public static void main(String[] args) {
        ...
        Statement ex10 = new CompoundStatement(
                new VariableDeclarationStatement(new model.type.IntType(), "v"),
                new CompoundStatement(
                        new VariableDeclarationStatement(new model.type.RefType(new model.type.IntType()), "a"),
                        new CompoundStatement(
                                ...
                                new CompoundStatement(
                                        ...
                                        new CompoundStatement(
                                                new ForkStatement(
                                                        new CompoundStatement(
                                                                new HeapWriteStatement("a", new ConstantExpression(new IntegerValue(30))),
                                                                new CompoundStatement(
        ...
        ProgramState prg10 = new ProgramState(new StackExecutionStack(), new MapSymbolTable(), new ListOut(), new MapFileTable(), ex10);
        RepositoryImpl repo10 = new RepositoryImpl(baseName + "10.txt");
        repo10.addProgram(prg10);
        ControllerImpl ctr10 = new ControllerImpl(repo10);
